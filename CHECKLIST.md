...
- [ ] Update `name` to `@ansvar/international-financial-regulation-mcp`
- [ ] Update `description`
...
git remote add origin git@github.com:Ansvar-Systems/international-financial-regulation-mcp.git
...
- [ ] Create directory `servers/international-financial-regulation-mcp/`
- [ ] Create `server.yaml`:
  ```yaml
