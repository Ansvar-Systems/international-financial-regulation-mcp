...
export function aboutServer(): AboutResult {
  return {
    ...
    data_sources: [
      { name: 'Basel Committee on Banking Supervision (BCBS)', url: 'https://www.bis.org/bcbs/publ/index.htm', authority: 'Bank for International Settlements' },
      { name: 'FATF Recommendations and Methodology', url: 'https://www.fatf-gafi.org', authority: 'Financial Action Task Force' },
      { name: 'FATF High-Risk and Grey Lists', url: 'https://www.fatf-gafi.org/en/countries/black-and-grey-lists.html', authority: 'Financial Action Task Force' },
      { name: 'IOSCO Objectives and Principles', url: 'https://www.iosco.org', authority: 'International Organization of Securities Commissions' },
      { name: 'IAIS Insurance Core Principles and ICS', url: 'https://www.iaisweb.org', authority: 'International Association of Insurance Supervisors' },
      { name: 'FSB Key Attributes and Policy Recommendations', url: 'https://www.fsb.org', authority: 'Financial Stability Board' },
      { name: 'CPMI-IOSCO Principles for FMIs', url: 'https://www.bis.org/cpmi/publ/index.htm', authority: 'BIS Committee on Payments and Market Infrastructures and IOSCO' },
      { name: 'IADI Core Principles for Deposit Insurance', url: 'https://www.iadi.org', authority: 'International Association of Deposit Insurers' },
      { name: 'G20 Financial Reform Commitments', url: 'https://www.g20.org', authority: 'G20 Leaders' },
    ],
    freshness: {
      last_ingestion: '2026-02-28',
      database_built: '2026-02-28',
    },
    disclaimer: 'International financial regulation data is compiled from public standards bodies. National implementation varies. Not financial, legal, or compliance advice.',
    network: {
